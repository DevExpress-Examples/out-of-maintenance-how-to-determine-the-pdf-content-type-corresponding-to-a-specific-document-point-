...
Namespace GetContentInfoExample
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Me.bsiContentType = New DevExpress.XtraBars.BarStaticItem()
...
'			Me.pdfViewer.MouseMove += New System.Windows.Forms.MouseEventHandler(Me.pdfViewer_MouseMove);
			...
			Me.ribbonControl1.Size = New System.Drawing.Size(847, 142)
			...
			' bsiContentType
			' 
			Me.bsiContentType.Caption = "Point the document content"
			Me.bsiContentType.Id = 24
			Me.bsiContentType.Name = "bsiContentType"
			Me.bsiContentType.TextAlignment = System.Drawing.StringAlignment.Near
			' 
			' pdfRibbonPage1
			' 
			...
			' ribbonPageGroup1
			' 
			Me.ribbonPageGroup1.ItemLinks.Add(Me.bsiContentType)
			Me.ribbonPageGroup1.Name = "ribbonPageGroup1"
			Me.ribbonPageGroup1.ShowCaptionButton = False
			Me.ribbonPageGroup1.Text = "Status"
			' 
			' pdfBarController1
			' 
			...
			Me.Name = "Form1"
			Me.Text = "GetContentInfo example"
'			Me.Load += New System.EventHandler(Me.Form1_Load);
		...
		Private bsiContentType As DevExpress.XtraBars.BarStaticItem
